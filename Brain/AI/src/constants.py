...
TAPPY_ORIGINAL_SERVER_IP = '127.0.0.1'  # IP of the server where the robot is attached toUSE_ADB = True                            # True if you want to use adb to get the screenshot, False if you want to use the Screenshotserver
