...
SCREENSHOT_SERVER_IP = '192.168.1.135'     # IP of the mobile phone with Screenshotserver on board
TAPPY_ORIGINAL_SERVER_IP = '192.168.1.122'  # IP of the server where the robot is attached to
